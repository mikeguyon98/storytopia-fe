...
export const ExploreTileFooter = ({ userId, likes, saves, postId }) => {
    ...
    const likePost = async () => {
        const response = await axios.post('http://localhost:8000/stories/like', null, {
            headers: {
    ...
    const unlikePost = async () => {
        const response = await axios.post('http://localhost:8000/stories/unlike', null, {
            headers: {
                Authorization: `Bearer ${currentUser.accessToken}`
            },
            params: {
    ...
    const savePost = async () => {
        const response = await axios.post('http://localhost:8000/stories/save', null, {
            headers: {
                Authorization: `Bearer ${currentUser.accessToken}`
            },
            params: {
    ...
    const unsavePost = async () => {
        const response = await axios.post('http://localhost:8000/stories/unsave', null, {
            headers: {
                Authorization: `Bearer ${currentUser.accessToken}`
            },
            params: {
